...
var isRepository = StringComparer.OrdinalIgnoreCase.Equals("ModernHttpClient", projectName);
...
var githubRepository = "ModernHttpClient";
...
var packageWhitelist = new[] { "ModernHttpClient"};

var buildSolution = "./ModernHttpClient_Build.sln";
